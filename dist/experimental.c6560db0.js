...
})({"lyNt5":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c4d0815fc6560db0";
"use strict";
...
},{}],"1KJLT":[function(require,module,exports) {
...
exports.default = async function(app) {
    if (location.hash == "#experimental") {
        ...
        }, section.letters(span.a("a"), span.b("b"), span.c("c"), span.d("d"), span.e("e"), span.f("f"), span.g("g"), span.h("h"), span.i("i"), span.j("j"), span.k("k"), span.l("l"), span.m("m"), span.n("n"), span.o("o"), span.p("p"), span.q("q"), span.r("r"), span.s("s"), span.t("t"), span.u("u"), span.v("v"), span.w("w"), span.x("x"), span.y("y"), span.z("z"), span.enter("enter"), span.space("space"), span.backspace("del")), section.output(mbstr));
        let is_busy = false;
        const setMBPos = (x, y)=>{
            mb.style.left = x + "px";
            mb.style.top = y + "px";
        ...
        document.onpointerup = function(e) {
            if (e.target.parentNode.classList.contains("letters")) {
                if (e.target.textContent == "del") mbstr.textContent = mbstr.textContent.slice(0, -1);
                else if (e.target.textContent == "space") mbstr.textContent += " ";
                else if (e.target.textContent == "enter") mbstr.textContent += "\n";
                else mbstr.textContent += e.target.textContent;
                is_busy = false;
            }
        };
...
},{}]},["lyNt5"], null, "parcelRequireac78")

//# sourceMappingURL=experimental.c6560db0.js.map
